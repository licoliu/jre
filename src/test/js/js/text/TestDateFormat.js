...
define(function(require, exports, module) {
  ...
  require("bootstrap!js.text.SimpleDateFormat");
  ...
  Class.forName({
    ...
    "@Test testFormat": function() {
      ...
      js.test.Assert.assertTrue("类js.text.TestDateFormat中的testFormat方法测试不通过", format1.format(d) == "2014-10-16 18:00:21 420");
      js.test.Assert.assertTrue("类js.text.TestDateFormat中的testFormat方法测试不通过", format1.format(t) == "2014-10-16 18:00:21 420");
      js.test.Assert.assertTrue("类js.text.TestDateFormat中的testFormat方法测试不通过", format2.format(d) == "201410161818021420星期四2893423下午66");
      js.test.Assert.assertTrue("类js.text.TestDateFormat中的testFormat方法测试不通过", format2.format(t) == "201410161818021420星期四2893423下午66");
