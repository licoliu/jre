...
define(function(require, exports, module) {
  ...
  /** 
   * @class js.text.SimpleDateFormat 
   * @extends {js.text.DateFormat}
   * @description 
   * <p>&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   * @since 0.0.1
   */
  return Class.forName( /** @lends js.text.SimpleDateFormat.prototype */ {
    name: 'class js.text.SimpleDateFormat extends js.text.DateFormat',
     ...
     * @function
     * @public 
     * @summary Returns a pattern string describing this date format.
     * @description Returns a pattern string describing this date format.
     *
     * @return {js.lang.String} a pattern string describing this date format.
     */
     ...
     * @function
     * @public 
     * @summary Returns a localized pattern string describing this date format.
     * @description Returns a localized pattern string describing this date format.
     *
     * @return {js.lang.String} a localized pattern string describing this date format.
     */
     ...
     * @function
     * @public 
     * @summary Applies the given pattern string to this date format.
     * @description Applies the given pattern string to this date format.
     *
     * @param {js.lang.String} pattern - the new date and time pattern for this date format
     */
     ...
     * @function
     * @public 
     * @summary Applies the given localized pattern string to this date format.
     * @description Applies the given localized pattern string to this date format.
     *
     * @param {js.lang.String} pattern - a String to be mapped to the new date and time format pattern for this format
     */
     ...
     * @function
     * @public 
     * @summary Gets a copy of the date and time format symbols of this date format.
     * @description Gets a copy of the date and time format symbols of this date format.
     *
     * @return {js.text.DateFormatSymbols} the date and time format symbols of this date format
     */
     ...
     * @function
     * @public 
     * @summary Sets the date and time format symbols of this date format.
     * @description Sets the date and time format symbols of this date format.
     *
     * @param {js.text.DateFormatSymbols} newFormatSymbols - the new date and time format symbols
     */
     ...
     * @function
     * @public 
     * @summary Creates a copy of this <code>SimpleDateFormat</code>. This also clones the format's date format symbols.
     * @description Creates a copy of this <code>SimpleDateFormat</code>. This also clones the format's date format symbols.
     *
     * @return {js.text.SimpleDateFormat} a clone of this <code>SimpleDateFormat</code>
     */
     ...
     * @function
     * @public 
     * @summary Compares the given object with this <code>SimpleDateFormat</code> for equality.
     * @description Compares the given object with this <code>SimpleDateFormat</code> for equality.
     *
     * @param {js.lang.Object} obj 
     * @return {js.lang.Boolean} true if the given object is equal to this <code>SimpleDateFormat</code>
     */
    "public boolean equals": function(obj) {
      ...
      var that = obj;
      if (!Object.isInstanceof(that, js.text.SimpleDateFormat)) {
        return false;
      }
